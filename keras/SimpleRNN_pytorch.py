...
def plot_training_history(history, test_loss=None, test_acc=None):
    ...
    # 设置标题
    ax1.set_title('SimpleRNN Training Curves', fontsize=14, fontweight='bold')
    ...
    # 保存图像
    plt.savefig('simplernn_training_curves.png', dpi=300, bbox_inches='tight')
    print("Training curves saved to 'simplernn_training_curves.png'")
